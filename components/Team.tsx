...
const people = [
  {
    ...
    bio: "Mission-driven CFO and Software Engineer who is passionate about creating products that will make a positive impact.  He studied Computer Science at Georgia Tech.",
